...
func Get_kcg_NG() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "kcg_NG",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEEE, y MMMM dd", Long: "y MMMM d", Medium: "y MMM d", Short: "yy/MM/dd"}, Time: cldr.CalendarDateFormat{Full: "HH:mm:ss zzzz", Long: "HH:mm:ss z", Medium: "HH:mm:ss", Short: "HH:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "Juw", Feb: "Swi", Mar: "Tsa", Apr: "Nya", May: "Tsw", Jun: "Ata", Jul: "Ana", Aug: "Ari", Sep: "Aku", Oct: "Swa", Nov: "Man", Dec: "Mas"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "1", Feb: "2", Mar: "3", Apr: "4", May: "5", Jun: "6", Jul: "7", Aug: "8", Sep: "9", Oct: "10", Nov: "11", Dec: "12"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Zwat Juwung", Feb: "Zwat Swiyang", Mar: "Zwat Tsat", Apr: "Zwat Nyai", May: "Zwat Tswon", Jun: "Zwat Ataah", Jul: "Zwat Anatat", Aug: "Zwat Arinai", Sep: "Zwat Akubunyung", Oct: "Zwat Swag", Nov: "Zwat Mangjuwang", Dec: "Zwat Swag-Ma-Suyang"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "Lad", Mon: "Tan", Tue: "Tal", Wed: "Lar", Thu: "Lam", Fri: "Jum", Sat: "Asa"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "S", Mon: "M", Tue: "T", Wed: "W", Thu: "T", Fri: "F", Sat: "S"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Ladi", Mon: "Tanii", Tue: "Talata", Wed: "Larba", Thu: "Lamit", Fri: "Juma", Sat: "Asabat"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.NGN: cldr.Currency{DisplayName: "Nera", Symbol: "₦"},
