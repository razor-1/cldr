...
func Get_gn_PY() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.EU:    "Union Européa",
			territory.EZ:    "Eurozóna",
			territory.GF:    "Guyána Francésa",
