	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "mɔni mǝ á syɛraleon", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "mɔni mǝ á syɛraleon (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "mɔni mǝ á afríka aná wɛs", Symbol: "F\u202fCFA"},
