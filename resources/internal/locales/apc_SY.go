	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.JOD: cldr.Currency{DisplayName: "", Symbol: "د.أ.\u200f"},
