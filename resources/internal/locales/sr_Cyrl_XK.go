...
func Get_sr_Cyrl_XK() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "sr_Cyrl_XK",
		...
		Languages: cldr.Languages{
			...
			language.GSW:     "швајцарски немачки",
			...
			language.ZEN:     "зенага",
			language.ZGH:     "стандардни марокански тамашек",
		...
		Territories: cldr.Territories{
			...
			territory.PL:    "Пољска",
			territory.PM:    "Свети Пјер и Микелон",
