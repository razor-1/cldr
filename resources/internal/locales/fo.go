	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				currency.AED: cldr.Currency{DisplayName: "Sameindu Emirríkini dirham", Symbol: ""},
				currency.AFN: cldr.Currency{DisplayName: "Afganistan afghani", Symbol: "؋"},
				currency.ALL: cldr.Currency{DisplayName: "Albania lek", Symbol: ""},
				currency.AMD: cldr.Currency{DisplayName: "Armenia dram", Symbol: "֏"},
				currency.ANG: cldr.Currency{DisplayName: "Niðurlonds Karibia gyllin", Symbol: ""},
				...
				currency.AZN: cldr.Currency{DisplayName: "Aserbadjan manat", Symbol: "₼"},
				currency.BAM: cldr.Currency{DisplayName: "Bosnia-Hersegovina mark (kann vekslast)", Symbol: "KM"},
				currency.BBD: cldr.Currency{DisplayName: "Barbados dollari", Symbol: "$"},
				currency.BDT: cldr.Currency{DisplayName: "Bangladesj taka", Symbol: "৳"},
				currency.BGN: cldr.Currency{DisplayName: "Bulgarskur lev", Symbol: ""},
				currency.BHD: cldr.Currency{DisplayName: "Barein dinar", Symbol: ""},
				currency.BIF: cldr.Currency{DisplayName: "Burundi frankur", Symbol: ""},
				currency.BMD: cldr.Currency{DisplayName: "Bermuda dollari", Symbol: "$"},
				currency.BND: cldr.Currency{DisplayName: "Brunei dollari", Symbol: "$"},
				...
				currency.BSD: cldr.Currency{DisplayName: "Bahamaoyggjar dollari", Symbol: "$"},
				currency.BTN: cldr.Currency{DisplayName: "Butan ngultrum", Symbol: ""},
				currency.BWP: cldr.Currency{DisplayName: "Botsvana pula", Symbol: "P"},
				currency.BYN: cldr.Currency{DisplayName: "Hvítarussiskur ruble", Symbol: "р."},
				currency.BYR: cldr.Currency{DisplayName: "Hvítarussland ruble (2000–2016)", Symbol: ""},
				currency.BZD: cldr.Currency{DisplayName: "Belis dollari", Symbol: "$"},
				currency.CAD: cldr.Currency{DisplayName: "Kanadiskur dollari", Symbol: "CA$"},
				currency.CDF: cldr.Currency{DisplayName: "Kongo frankur", Symbol: ""},
				currency.CHF: cldr.Currency{DisplayName: "sveisiskur frankur", Symbol: ""},
				currency.CLP: cldr.Currency{DisplayName: "Kili peso", Symbol: "$"},
				currency.CNH: cldr.Currency{DisplayName: "kinesiskur yuan (úr landi)", Symbol: ""},
				...
				currency.CRC: cldr.Currency{DisplayName: "Kosta Rika colón", Symbol: "₡"},
				currency.CUC: cldr.Currency{DisplayName: "Kuba peso (sum kann vekslast)", Symbol: "$"},
				currency.CUP: cldr.Currency{DisplayName: "Kuba peso", Symbol: "$"},
				currency.CVE: cldr.Currency{DisplayName: "Grønhøvdaoyggjar escudo", Symbol: ""},
				currency.CZK: cldr.Currency{DisplayName: "Kekkiskt koruna", Symbol: "Kč"},
				currency.DJF: cldr.Currency{DisplayName: "Djibuti frankur", Symbol: ""},
				...
				currency.EGP: cldr.Currency{DisplayName: "Egyptaland pund", Symbol: "E£"},
				currency.ERN: cldr.Currency{DisplayName: "Eritrea nakfa", Symbol: ""},
				currency.ESP: cldr.Currency{DisplayName: "", Symbol: "₧"},
				currency.ETB: cldr.Currency{DisplayName: "Etiopia birr", Symbol: ""},
				currency.EUR: cldr.Currency{DisplayName: "Evra", Symbol: "€"},
				currency.FJD: cldr.Currency{DisplayName: "Fiji dollari", Symbol: "$"},
				currency.FKP: cldr.Currency{DisplayName: "Falklandsoyggjar pund", Symbol: "£"},
				currency.GBP: cldr.Currency{DisplayName: "bretsk pund", Symbol: "£"},
				currency.GEL: cldr.Currency{DisplayName: "Georgia lari", Symbol: "₾"},
				currency.GHS: cldr.Currency{DisplayName: "Gana cedi", Symbol: "GH₵"},
				currency.GIP: cldr.Currency{DisplayName: "Gibraltar pund", Symbol: "£"},
				currency.GMD: cldr.Currency{DisplayName: "Gambia dalasi", Symbol: ""},
				currency.GNF: cldr.Currency{DisplayName: "Guinea frankur", Symbol: "FG"},
				currency.GTQ: cldr.Currency{DisplayName: "Guatemala quetzal", Symbol: "Q"},
				currency.GYD: cldr.Currency{DisplayName: "Gujana dollari", Symbol: "$"},
				...
				currency.HUF: cldr.Currency{DisplayName: "Ungarskur forintur", Symbol: "Ft"},
				currency.IDR: cldr.Currency{DisplayName: "Indonesia rupiah", Symbol: "Rp"},
				...
				currency.IRR: cldr.Currency{DisplayName: "iranskir rials", Symbol: ""},
				currency.ISK: cldr.Currency{DisplayName: "íslendsk króna", Symbol: "kr"},
				currency.JMD: cldr.Currency{DisplayName: "Jamaika dollari", Symbol: "$"},
				currency.JOD: cldr.Currency{DisplayName: "Jordan dinar", Symbol: ""},
				currency.JPY: cldr.Currency{DisplayName: "japanskur yen", Symbol: "JP¥"},
				currency.KES: cldr.Currency{DisplayName: "kenjanskur skillingur", Symbol: ""},
				currency.KGS: cldr.Currency{DisplayName: "Kirgisia som", Symbol: "⃀"},
				currency.KHR: cldr.Currency{DisplayName: "Kambodja riel", Symbol: "៛"},
				currency.KMF: cldr.Currency{DisplayName: "Komoroyggjar frankur", Symbol: "CF"},
				currency.KPW: cldr.Currency{DisplayName: "Norðurkorea won", Symbol: "₩"},
				currency.KRW: cldr.Currency{DisplayName: "Suðurkorea won", Symbol: "₩"},
				currency.KWD: cldr.Currency{DisplayName: "Kuvait dinar", Symbol: ""},
				currency.KYD: cldr.Currency{DisplayName: "Caymanoyggjar dollari", Symbol: "$"},
				currency.KZT: cldr.Currency{DisplayName: "Kasakstan tenge", Symbol: "₸"},
				currency.LAK: cldr.Currency{DisplayName: "Laos kip", Symbol: "₭"},
				currency.LBP: cldr.Currency{DisplayName: "Libanon pund", Symbol: "L£"},
				currency.LKR: cldr.Currency{DisplayName: "Sri Lanka rupi", Symbol: "Rs"},
				currency.LRD: cldr.Currency{DisplayName: "Liberia dollari", Symbol: "$"},
				currency.LSL: cldr.Currency{DisplayName: "Lesoto loti", Symbol: ""},
				currency.LTL: cldr.Currency{DisplayName: "", Symbol: "Lt"},
				currency.LVL: cldr.Currency{DisplayName: "", Symbol: "Ls"},
				currency.LYD: cldr.Currency{DisplayName: "Libya dinar", Symbol: ""},
				currency.MAD: cldr.Currency{DisplayName: "Marokko dirham", Symbol: ""},
				currency.MDL: cldr.Currency{DisplayName: "Moldovanskur leu", Symbol: ""},
				currency.MGA: cldr.Currency{DisplayName: "Madagaskar ariary", Symbol: "Ar"},
				currency.MKD: cldr.Currency{DisplayName: "Makedónia denar", Symbol: ""},
				currency.MMK: cldr.Currency{DisplayName: "Myanmar (Burma) kyat", Symbol: "K"},
				currency.MNT: cldr.Currency{DisplayName: "Mongolia tugrik", Symbol: "₮"},
				currency.MOP: cldr.Currency{DisplayName: "Makao pataca", Symbol: ""},
				currency.MRO: cldr.Currency{DisplayName: "Móritania ouguiya (1973–2017)", Symbol: ""},
				currency.MRU: cldr.Currency{DisplayName: "Móritania ouguiya", Symbol: ""},
				currency.MUR: cldr.Currency{DisplayName: "Móritius rupi", Symbol: "Rs"},
				currency.MVR: cldr.Currency{DisplayName: "Maldivoyggjar rufiyaa", Symbol: ""},
				currency.MWK: cldr.Currency{DisplayName: "Malavi kwacha", Symbol: ""},
				...
				currency.MZN: cldr.Currency{DisplayName: "Mosambik metical", Symbol: ""},
				currency.NAD: cldr.Currency{DisplayName: "Namibia dollari", Symbol: "$"},
				currency.NGN: cldr.Currency{DisplayName: "Nigeria naira", Symbol: "₦"},
				currency.NIO: cldr.Currency{DisplayName: "Nikaragua córdoba", Symbol: "C$"},
				currency.NOK: cldr.Currency{DisplayName: "norsk króna", Symbol: "kr"},
				currency.NPR: cldr.Currency{DisplayName: "Nepal rupi", Symbol: "Rs"},
				...
				currency.PGK: cldr.Currency{DisplayName: "Papua Nýguinea kina", Symbol: ""},
				currency.PHP: cldr.Currency{DisplayName: "Filipsoyggjar peso", Symbol: "PHP"},
				currency.PKR: cldr.Currency{DisplayName: "Pakistan rupi", Symbol: "Rs"},
				currency.PLN: cldr.Currency{DisplayName: "Pólskur zloty", Symbol: "zł"},
				currency.PYG: cldr.Currency{DisplayName: "Paraguai guarani", Symbol: "₲"},
				currency.QAR: cldr.Currency{DisplayName: "Katar rial", Symbol: ""},
				currency.RON: cldr.Currency{DisplayName: "Rumenia leu", Symbol: "lei"},
				currency.RSD: cldr.Currency{DisplayName: "Serbia dinar", Symbol: ""},
				currency.RUB: cldr.Currency{DisplayName: "Russland ruble", Symbol: "₽"},
				currency.RWF: cldr.Currency{DisplayName: "Ruanda frankur", Symbol: "RF"},
				currency.SAR: cldr.Currency{DisplayName: "Saudiarabia riyal", Symbol: ""},
				currency.SBD: cldr.Currency{DisplayName: "Salomonoyggjar dollari", Symbol: "$"},
				currency.SCR: cldr.Currency{DisplayName: "Seyskelloyggjar rupi", Symbol: ""},
				currency.SDG: cldr.Currency{DisplayName: "Sudan pund", Symbol: ""},
				currency.SEK: cldr.Currency{DisplayName: "svensk króna", Symbol: "kr"},
				currency.SGD: cldr.Currency{DisplayName: "Singapor dollari", Symbol: "$"},
				currency.SHP: cldr.Currency{DisplayName: "St. Helena pund", Symbol: "£"},
				currency.SLE: cldr.Currency{DisplayName: "Sierra Leona leone", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Sierra Leona leone (1964—2022)", Symbol: ""},
				currency.SOS: cldr.Currency{DisplayName: "Somalia skillingur", Symbol: ""},
				currency.SRD: cldr.Currency{DisplayName: "Surinam dollari", Symbol: "$"},
				currency.SSP: cldr.Currency{DisplayName: "Suðursudan pund", Symbol: "£"},
				currency.STD: cldr.Currency{DisplayName: "Sao Tome & Prinsipi dobra (1977–2017)", Symbol: ""},
				currency.STN: cldr.Currency{DisplayName: "Sao Tome & Prinsipi dobra", Symbol: "Db"},
				currency.SYP: cldr.Currency{DisplayName: "Sýria pund", Symbol: "£"},
				currency.SZL: cldr.Currency{DisplayName: "Svasiland lilangeni", Symbol: ""},
				currency.THB: cldr.Currency{DisplayName: "Tailand baht", Symbol: "฿"},
				currency.TJS: cldr.Currency{DisplayName: "Tadsjikistan somoni", Symbol: ""},
				currency.TMT: cldr.Currency{DisplayName: "Turkmenistan manat", Symbol: ""},
				currency.TND: cldr.Currency{DisplayName: "Tunesia dinar", Symbol: ""},
				currency.TOP: cldr.Currency{DisplayName: "Tonga paʻanga", Symbol: "T$"},
				currency.TRY: cldr.Currency{DisplayName: "Turkaland liri", Symbol: "₺"},
				currency.TTD: cldr.Currency{DisplayName: "Trinidad & Tobago dollari", Symbol: "$"},
				currency.TWD: cldr.Currency{DisplayName: "Taivan new dollari", Symbol: "NT$"},
				currency.TZS: cldr.Currency{DisplayName: "Tansania skillingur", Symbol: ""},
				currency.UAH: cldr.Currency{DisplayName: "Ukraina hryvnia", Symbol: "₴"},
				currency.UGX: cldr.Currency{DisplayName: "Uganda skillingur", Symbol: ""},
				currency.USD: cldr.Currency{DisplayName: "US dollari", Symbol: "US$"},
				currency.UYU: cldr.Currency{DisplayName: "Uruguai peso", Symbol: "$"},
				currency.UZS: cldr.Currency{DisplayName: "Usbekistan som", Symbol: ""},
				currency.VEF: cldr.Currency{DisplayName: "Venesuela bolívar (2008–2018)", Symbol: "Bs"},
				...
				currency.XOF: cldr.Currency{DisplayName: "Vesturafrika CFA frankur", Symbol: "F\u202fCFA"},
				...
				currency.ZAR: cldr.Currency{DisplayName: "Suðurafrika rand", Symbol: "R"},
				currency.ZMW: cldr.Currency{DisplayName: "Sambia kwacha", Symbol: "ZK"},
			},
		},
