...
func Get_ii_CN() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "ii_CN",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "y MMMM d, EEEE", Long: "y MMMM d", Medium: "y MMM d", Short: "y-MM-dd"}, Time: cldr.CalendarDateFormat{Full: "HH:mm:ss zzzz", Long: "HH:mm:ss z", Medium: "HH:mm:ss", Short: "HH:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "ꋧꃅꎕꏦꄮꈉ{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "1", Feb: "2", Mar: "3", Apr: "4", May: "5", Jun: "6", Jul: "7", Aug: "8", Sep: "9", Oct: "10", Nov: "11", Dec: "12"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "ꋍꆪ", Feb: "ꑍꆪ", Mar: "ꌕꆪ", Apr: "ꇖꆪ", May: "ꉬꆪ", Jun: "ꃘꆪ", Jul: "ꏃꆪ", Aug: "ꉆꆪ", Sep: "ꈬꆪ", Oct: "ꊰꆪ", Nov: "ꊯꊪꆪ", Dec: "ꊰꑋꆪ"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "ꑬꆏ", Mon: "ꆏꋍ", Tue: "ꆏꑍ", Wed: "ꆏꌕ", Thu: "ꆏꇖ", Fri: "ꆏꉬ", Sat: "ꆏꃘ"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "ꆏ", Mon: "ꋍ", Tue: "ꑍ", Wed: "ꌕ", Thu: "ꇖ", Fri: "ꉬ", Sat: "ꃘ"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "ꑬꆏꑍ", Mon: "ꆏꊂꋍ", Tue: "ꆏꊂꑍ", Wed: "ꆏꊂꌕ", Thu: "ꆏꊂꇖ", Fri: "ꆏꊂꉬ", Sat: "ꆏꊂꃘ"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "ꎸꄑ", PM: "ꁯꋒ"}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.CNY: cldr.Currency{DisplayName: "", Symbol: "¥"},
				...
				currency.XXX: cldr.Currency{DisplayName: "ꅉꀋꐚꌠꌋꆀꎆꃀꀋꈁꀐꌠ", Symbol: "¤"},
		...
		Languages: cldr.Languages{
			language.AR:      "ꀊꇁꀨꉙ",
			language.AR_001:  "ꀊꇁꀨꉙ（ꋧꃅ）",
			language.DE:      "ꄓꇩꉙ",
			language.EN:      "ꑱꇩꉙ",
			language.ES:      "ꑭꀠꑸꉙ",
			language.FR:      "ꃔꇩꉙ",
			language.HI:      "ꑴꄃꉙ",
			language.HI_LATN: "ꑴꐛꑱꉙ",
			language.II:      "ꆈꌠꉙ",
			language.IT:      "ꑴꄊꆺꉙ",
			language.JA:      "ꏝꀪꉙ",
			language.NDS:     "ꃅꄷꀁꂥꄓꉙ",
