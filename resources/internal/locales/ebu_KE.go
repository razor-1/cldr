...
func Get_ebu_KE() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "ebu_KE",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEEE, d MMMM y", Long: "d MMMM y", Medium: "d MMM y", Short: "dd/MM/y"}, Time: cldr.CalendarDateFormat{Full: "HH:mm:ss zzzz", Long: "HH:mm:ss z", Medium: "HH:mm:ss", Short: "HH:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "Mbe", Feb: "Kai", Mar: "Kat", Apr: "Kan", May: "Gat", Jun: "Gan", Jul: "Mug", Aug: "Knn", Sep: "Ken", Oct: "Iku", Nov: "Imw", Dec: "Igi"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "M", Feb: "K", Mar: "K", Apr: "K", May: "G", Jun: "G", Jul: "M", Aug: "K", Sep: "K", Oct: "I", Nov: "I", Dec: "I"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Mweri wa mbere", Feb: "Mweri wa kaĩri", Mar: "Mweri wa kathatũ", Apr: "Mweri wa kana", May: "Mweri wa gatano", Jun: "Mweri wa gatantatũ", Jul: "Mweri wa mũgwanja", Aug: "Mweri wa kanana", Sep: "Mweri wa kenda", Oct: "Mweri wa ikũmi", Nov: "Mweri wa ikũmi na ũmwe", Dec: "Mweri wa ikũmi na Kaĩrĩ"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "Kma", Mon: "Tat", Tue: "Ine", Wed: "Tan", Thu: "Arm", Fri: "Maa", Sat: "NMM"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "K", Mon: "N", Tue: "N", Wed: "N", Thu: "A", Fri: "M", Sat: "N"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Kiumia", Mon: "Njumatatu", Tue: "Njumaine", Wed: "Njumatano", Thu: "Aramithi", Fri: "Njumaa", Sat: "NJumamothii"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "KI", PM: "UT"}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.AUD: cldr.Currency{DisplayName: "Dora ya Australia", Symbol: "A$"},
		...
		Languages: cldr.Languages{
			language.AK:  "Kĩakan",
			language.AM:  "Kĩamhari",
			language.AR:  "Kĩarabu",
			language.BE:  "Kĩmbelarusi",
			language.BG:  "Kĩbulgaria",
			language.BN:  "Kĩbangla",
			language.CS:  "Kĩcheki",
			language.DE:  "Kĩnjeremani",
			language.EBU: "Kĩembu",
			language.EL:  "Kĩngriki",
			language.EN:  "Kĩthungu",
			language.ES:  "Kĩhispania",
			language.FA:  "Kĩanjemi",
			language.FR:  "Kĩfaransa",
			language.HA:  "Kĩhausa",
			language.HI:  "Kĩhindĩ",
			language.HU:  "Kĩhungari",
			language.ID:  "Kĩindonesia",
			language.IG:  "Kĩigbo",
			language.IT:  "Kĩitaliano",
			language.JA:  "Kĩnjapani",
			language.JV:  "Kĩjava",
			...
			language.NL:  "Kĩholanzi",
			language.PA:  "Kĩpunjabi",
			language.PL:  "Kĩpolandi",
			language.PT:  "Kĩreno",
			language.RO:  "Kĩromania",
			language.RU:  "Kĩrusi",
			language.RW:  "Kĩnyarwanda",
			language.SO:  "Kĩsomali",
			language.SV:  "Kĩswidi",
			language.TA:  "Kĩtamil",
			language.TH:  "Kĩtailandi",
			language.TR:  "Kĩturuki",
			language.UK:  "Kĩukrania",
			language.UR:  "Kĩurdu",
