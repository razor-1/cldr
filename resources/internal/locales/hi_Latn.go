	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.XXX: cldr.Currency{DisplayName: "currency ki unknown unit", Symbol: "¤"},
		...
		Territories: cldr.Territories{
			...
			territory.XB: "Pseudo-Bidirectional",
		},
	}
}
