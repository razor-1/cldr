	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.XXX: cldr.Currency{DisplayName: "Wala Nailhi nga Kwarta", Symbol: "¤"},
		...
		Languages: cldr.Languages{
			language.AR:      "Arabic",
			language.AR_001:  "Modernong Standard nga Arabic",
			language.BN:      "Bangla",
			...
			language.ES_ES:   "Espanyol (Europa)",
			language.FR:      "Pranses",
			language.HI:      "Hindi",
			...
			language.TH:      "Thai",
			language.TR:      "Turkish",
			language.UND:     "Wala Mailhing Pinulongan",
			language.ZH:      "Chinese, Mandarin",
			language.ZH_HANS: "Pinasimple nga Mandarin Chinese",
			language.ZH_HANT: "Tradisyonal nga Mandarin Chinese",
		},
		Territories: cldr.Territories{
			...
			territory.IN:    "India",
			territory.IO:    "Teritoryo sa British Indian Ocean",
			territory.IQ:    "Iraq",
			territory.IR:    "Iran",
			...
			territory.UN:    "Hiniusang Kanasoran",
