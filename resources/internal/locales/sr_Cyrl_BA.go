	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BYN: cldr.Currency{DisplayName: "Бјелоруска рубља", Symbol: "р."},
				...
				currency.KPW: cldr.Currency{DisplayName: "Сјевернокорејски вон", Symbol: "₩"},
		...
		Languages: cldr.Languages{
			...
			language.CRL:     "сјевероисточни кри",
			language.CRM:     "музкри",
			...
			language.DE_CH:   "швајцарски високи њемачки",
			...
			language.FRR:     "сјевернофризијски",
			...
			language.GSW:     "њемачки (Швајцарска)",
			...
			language.OJ:      "оџибве",
			language.OJB:     "сјеверозападни оџибва",
		...
		Territories: cldr.Territories{
			...
			territory.BZ:    "Белизе",
			territory.CA:    "Канада",
			territory.CC:    "Кокосова (Килинг) острва",
			...
			territory.HK:    "Хонгконг (САО Кине)",
			territory.HM:    "острво Херд и острва Макдоналд",
			...
			territory.UG:    "Уганда",
			territory.UM:    "Спољна острва САД",
