	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.NOK: cldr.Currency{DisplayName: "norgga kruvdno", Symbol: "Nkr"},
				...
				currency.SEK: cldr.Currency{DisplayName: "ruoŧŧa kruvdno", Symbol: "kr"},
