...
func Get_az_Arab() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			...
			language.AM:      "آمهارجا",
			language.AR:      "عربجه",
			language.AR_001:  "استاندارد عربجه",
			language.AS:      "آسامجا",
			language.ASA:     "آسوجا",
			language.AZ:      "آذریجه",
			language.AZ_ARAB: "تۆرکجه",
			language.BA:      "باشقیرجا",
			language.BE:      "بئلاروسجا",
			language.BEM:     "بئمباجا",
			language.BEZ:     "بئناجا",
			language.BG:      "بۇلقارجا",
			language.BGN:     "دوْغو بلوچجا",
			language.BM:      "بامباراجا",
			language.BN:      "بنگالجا",
			language.BR:      "برئتونجا",
			language.BRX:     "بوْدوجا",
			language.BS:      "بوْسنیاجا",
			language.CA:      "کاتالانجا",
			language.CE:      "چئچئنجه",
			language.CGG:     "چیقاجا",
			language.CHR:     "چئروکیجه",
			language.CKB:     "اوْرتا کۆردجه",
			language.CO:      "کوْرسیکاجا",
			language.CS:      "چئکجه",
			language.CV:      "چۇواشجا",
			language.DA:      "دانجا",
			language.DE:      "آلمانجا",
			language.DUA:     "دۇالاجا",
			language.DZ:      "دزونگخا",
			language.EBU:     "ائمبوجا",
			language.EE:      "اِوه\u200cجه",
			language.EL:      "یونانجا",
			language.EN:      "اینگیلیزجه",
			language.EO:      "اِسپرانتو",
			language.ES:      "اسپانیاجا",
			language.ES_419:  "لاتین آمریکا اسپانیاجاسی",
			language.ES_ES:   "اۇروپا اسپانیاجاسی",
			language.ES_MX:   "مکزیک اسپانیاجاسی",
			language.ET:      "اِستونجا",
			language.EU:      "باسکجا",
			language.FA:      "فارسجا",
			language.FI:      "فینجه",
			language.FIL:     "فیلیپینجه",
			language.FJ:      "فیجیجه",
			language.FO:      "فاروئه\u200cجه",
			language.FR:      "فرانساجا",
			language.GAG:     "قاقائوزجا",
			language.GL:      "قالیسیاجا",
			language.GSW:     "سویس آلمانجاسی",
			language.HE:      "عبریجه",
			language.HI:      "هیندجه",
			language.HR:      "کروواسجا",
			language.HY:      "ائرمنیجه",
			language.IT:      "ایتالیاجا",
			language.JA:      "ژاپونجا",
			language.KA:      "گۆرجوجه",
			language.KK:      "قازاقجا",
			language.KM:      "خمئرجه",
			language.KO:      "کوْره\u200cجه",
			language.KS:      "کشمیرجه",
			language.KSF:     "بافیاجا",
			language.KU:      "کۆردجه",
			language.KW:      "کوْرنجا",
			language.KY:      "قیرقیزجا",
			language.LA:      "لاتینجه",
			language.LG:      "قانداجا",
			language.LRC:     "قۇزئی لوْرجه",
			language.MK:      "مقدونیجه",
			language.MN:      "موْغولجا",
			language.MY:      "بۇرماجا",
			language.MZN:     "مازنیجه",
			language.NL:      "هوْلندجه",
			language.PA:      "پنجابجا",
			language.PS:      "پشتوجه",
			language.PT:      "پوْرتغالجه",
			language.RO:      "رومانیاجا",
			language.RU:      "روسجا",
			language.SD:      "سیندیجه",
			language.SDH:     "گۆنئی کۆردجه",
			language.SK:      "اسلواکجا",
			language.SQ:      "آلبانیاجا",
			language.SR:      "صربجه",
			language.SV:      "سوئدجه",
			language.SW:      "سواحیلیجه",
			language.SW_CD:   "کوْنقو سواحیلیسی",
			language.TA:      "تامیلجه",
			language.TG:      "تاجیکجه",
			language.TK:      "تۆرکمنجه",
			language.TR:      "آنادولو تۆرکجه\u200cسی",
			language.TT:      "تاتارجا",
			language.UG:      "اۇیغورجا",
			language.UK:      "اۇکراینجا",
			language.UND:     "تانینمایان دیل",
			language.UR:      "اوْردوجا",
			language.UZ:      "اؤزبکجه",
			language.VI:      "ویتنامجا",
			language.ZH:      "چینجه",
			language.ZH_HANS: "ساده\u200cلنمیش چینجه",
			language.ZH_HANT: "سنتی چینجه",
			language.ZU:      "زۇلوجا",
		},
		Territories: cldr.Territories{
			territory.V_001: "دۆنیا",
		},
	}
}
