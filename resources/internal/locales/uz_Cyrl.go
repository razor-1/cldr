...
func Get_uz_Cyrl() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.FJ:    "Фижи",
			territory.FK:    "Фолкленд ороллари",
			...
			territory.GY:    "Гаяна",
			territory.HK:    "Гонконг (Хитой ММҲ)",
			...
			territory.US:    "Америка Қўшма Штатлари",
