	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Leeon", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Leeon (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "CFA Fraŋ (BCEAO)", Symbol: "F\u202fCFA"},
		...
		Territories: cldr.Territories{
			...
			territory.KP: "Gurma Kooree",
			territory.KR: "Hawsa Kooree",
			territory.KW: "Kuweet",
