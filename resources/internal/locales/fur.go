	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BYN: cldr.Currency{DisplayName: "Rubli bielorùs", Symbol: ""},
		...
		Languages: cldr.Languages{
			...
			language.ES_MX:   "spagnûl messican",
			language.ET:      "eston",
			language.EU:      "basc",
			language.FA:      "persian",
			language.FF:      "fulah",
		...
		Territories: cldr.Territories{
			...
			territory.MK:    "Macedonie dal Nord",
			territory.ML:    "Mali",
			...
			territory.WS:    "Samoa",
			territory.XA:    "Pseudoacents",
			territory.XK:    "Cossovo",
			territory.YE:    "Yemen",
