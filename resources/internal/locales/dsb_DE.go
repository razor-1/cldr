	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.ALL: cldr.Currency{DisplayName: "albański lek", Symbol: ""},
				...
				currency.BGN: cldr.Currency{DisplayName: "bulgarski lew", Symbol: ""},
				...
				currency.KPW: cldr.Currency{DisplayName: "pódpołnocnokorejski won", Symbol: "₩"},
		...
		Languages: cldr.Languages{
			...
			language.ALT:     "pódpołdnjowa altaišćina",
			...
			language.FRC:     "cajun francojšćina",
			language.FRR:     "pódpołnocna frizišćina",
			...
			language.HAX:     "pódpołdnjowa haidašćina",
			...
			language.IK:      "inupiak",
			language.IKT:     "pódwjacornokanadiska inuktitutšćina",
			...
			language.NQO:     "n’ko",
			language.NR:      "pódpołdnjowa ndebelšćina",
			language.NSO:     "połnocna sothošćina",
			language.NUS:     "nuer",
			language.NV:      "navaho",
			language.NY:      "nyanja",
			language.NYN:     "nyankole",
			language.OC:      "okcitanšćina",
			language.OJB:     "dłujkowjacorna ojibwašćina",
			language.OJC:     "centralna ojibwašćina",
			language.OJS:     "oji-creešćina",
			language.OJW:     "pódwjacorna ojibwašćina",
			...
			language.SLH:     "pódpołdnjowa lushootseedšćina",
			...
			language.SZL:     "šlazyńšćina",
			language.TA:      "tamilšćina",
			language.TCE:     "pódpołdnjowa tutchonšćina",
			...
			language.TTM:     "połnocna tutchonšćina",
		...
		Territories: cldr.Territories{
			...
			territory.V_202: "subsaharojska Afrika",
			...
			territory.GA:    "Gabun",
			territory.GB:    "Zjadnośone kralejstwo",
			...
			territory.GY:    "Guyana",
			territory.HK:    "Wósebna zastojnstwowa cona Hongkong",
			...
			territory.MK:    "Pódpołnocna Makedańska",
			territory.ML:    "Mali",
			territory.MM:    "Myanmar",
			territory.MN:    "Mongolska",
			territory.MO:    "Wósebna zastojnstwowa cona Macao",
			...
			territory.PS:    "Palestinski awtonomny teritorium",
			...
			territory.UN:    "Zjadnośone narody",
			territory.US:    "Zjadnośone staty Ameriki",
