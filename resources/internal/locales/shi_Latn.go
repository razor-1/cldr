	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "liyun", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "liyun (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "frank ṣifa bisaw", Symbol: "F\u202fCFA"},
