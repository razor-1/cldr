...
func Get_kam() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.RW: "Lwanda",
			territory.SA: "Saudi",
			territory.SB: "Isiwa sya Solomon",
			...
			territory.ZM: "Nzambia",
			territory.ZW: "Nzimbambwe",
		},
	}
}
