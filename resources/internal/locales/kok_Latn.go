...
func Get_kok_Latn() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "kok_Latn",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEEE, d MMMM, y", Long: "d MMMM, y", Medium: "d MMM, y", Short: "d-M-yy"}, Time: cldr.CalendarDateFormat{Full: "a\u202fh:mm:ss\u202fzzzz", Long: "a\u202fh:mm:ss z", Medium: "a\u202fh:mm:ss", Short: "a\u202fh:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1}, {0}", Long: "{1}, {0}", Medium: "{1}, {0}", Short: "{1}, {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "Jan", Feb: "Feb", Mar: "Mar", Apr: "Abr", May: "Mai", Jun: "", Jul: "Jul", Aug: "Ago", Sep: "Set", Oct: "Otu", Nov: "Nov", Dec: "Dez"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "J", Feb: "F", Mar: "M", Apr: "A", May: "M", Jun: "J", Jul: "J", Aug: "A", Sep: "S", Oct: "O", Nov: "N", Dec: "D"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Janer", Feb: "Febrer", Mar: "Mars", Apr: "Abril", May: "Mai", Jun: "Jun", Jul: "Julai", Aug: "Agost", Sep: "Setembr", Oct: "Otubr", Nov: "Novembr", Dec: "Dezembr"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "Ait", Mon: "Som", Tue: "Mon", Wed: "Bud", Thu: "Bre", Fri: "Suk", Sat: "Son"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "A", Mon: "S", Tue: "M", Wed: "B", Thu: "B", Fri: "S", Sat: "S"}, Short: cldr.CalendarDayFormatNameValue{Sun: "Ai", Mon: "Sm", Tue: "Mg", Wed: "Bu", Thu: "Br", Fri: "Su", Sat: "Sn"}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Aitar", Mon: "Somar", Tue: "Mongllar", Wed: "Budhvar", Thu: "Birestar", Fri: "Sukrar", Sat: "Sonvar"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "sokallim", PM: "sanje"}}}},
		Number: cldr.Number{
		...
		Languages: cldr.Languages{
			...
			language.EL:  "Grik",
			language.EN:  "Inglix",
			language.ES:  "Ispanhol",
			language.FR:  "Fransez",
			language.KN:  "Kon’nodd",
			language.KOK: "Konknni",
			language.MR:  "Moratthi",
			language.ZH:  "Chini",
		},
		Territories: cldr.Territories{
			...
			territory.DE: "Jermon",
			territory.EG: "Ejipt",
			territory.ES: "Ispania",
			territory.FR: "Frans",
			territory.GR: "Gres",
			territory.IN: "Bharot",
			territory.IT: "Italia",
			territory.LY: "Libia",
			territory.MK: "Ut’tor Masedonia",
			territory.RU: "Roxya",
		},
	}
}
