...
func Get_ki_KE() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "ki_KE",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEEE, d MMMM y", Long: "d MMMM y", Medium: "d MMM y", Short: "dd/MM/y"}, Time: cldr.CalendarDateFormat{Full: "HH:mm:ss zzzz", Long: "HH:mm:ss z", Medium: "HH:mm:ss", Short: "HH:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "JEN", Feb: "WKR", Mar: "WGT", Apr: "WKN", May: "WTN", Jun: "WTD", Jul: "WMJ", Aug: "WNN", Sep: "WKD", Oct: "WIK", Nov: "WMW", Dec: "DIT"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "J", Feb: "K", Mar: "G", Apr: "K", May: "G", Jun: "G", Jul: "M", Aug: "K", Sep: "K", Oct: "I", Nov: "I", Dec: "D"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Njenuarĩ", Feb: "Mwere wa kerĩ", Mar: "Mwere wa gatatũ", Apr: "Mwere wa kana", May: "Mwere wa gatano", Jun: "Mwere wa gatandatũ", Jul: "Mwere wa mũgwanja", Aug: "Mwere wa kanana", Sep: "Mwere wa kenda", Oct: "Mwere wa ikũmi", Nov: "Mwere wa ikũmi na ũmwe", Dec: "Ndithemba"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "KMA", Mon: "NTT", Tue: "NMN", Wed: "NMT", Thu: "ART", Fri: "NMA", Sat: "NMM"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "K", Mon: "N", Tue: "N", Wed: "N", Thu: "A", Fri: "N", Sat: "N"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Kiumia", Mon: "Njumatatũ", Tue: "Njumaine", Wed: "Njumatana", Thu: "Aramithi", Fri: "Njumaa", Sat: "Njumamothi"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "Kiroko", PM: "Hwaĩ-inĩ"}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.CAD: cldr.Currency{DisplayName: "Ndora ya Kananda", Symbol: "CA$"},
				...
				currency.GBP: cldr.Currency{DisplayName: "Mbauini cia Ngeretha", Symbol: "£"},
				...
				currency.INR: cldr.Currency{DisplayName: "Rubia rwa India", Symbol: "₹"},
				currency.ISK: cldr.Currency{DisplayName: "", Symbol: "kr"},
				currency.JMD: cldr.Currency{DisplayName: "", Symbol: "$"},
				currency.JPY: cldr.Currency{DisplayName: "Sarafu ya Kijapani", Symbol: "JP¥"},
				currency.KES: cldr.Currency{DisplayName: "Ciringi ya Kenya", Symbol: "Ksh"},
				...
				currency.SOS: cldr.Currency{DisplayName: "ciringi cia cumarĩ", Symbol: ""},
				...
				currency.TZS: cldr.Currency{DisplayName: "ciringi cia Tanizania", Symbol: ""},
				currency.UAH: cldr.Currency{DisplayName: "", Symbol: "₴"},
				currency.UGX: cldr.Currency{DisplayName: "ciringi cia Ũganda", Symbol: ""},
				currency.USD: cldr.Currency{DisplayName: "Ndora cia Amerika", Symbol: "US$"},
		...
		Languages: cldr.Languages{
			...
			language.DE: "Kĩnjeremani",
			language.EL: "Kigiriki",
			language.EN: "Gĩthungũ",
			language.ES: "Kihispania",
			language.FA: "Kiajemi",
			language.FR: "Kĩbaranja",
			language.HA: "Kihausa",
			language.HI: "Kĩhĩndĩ",
			language.HU: "Kihungari",
			language.ID: "Kiindonesia",
			language.IG: "Kiigbo",
			language.IT: "Kĩtaliano",
			language.JA: "Kĩnjabani",
			language.JV: "Kijava",
			language.KI: "Gikuyu",
		...
		Territories: cldr.Territories{
			...
			territory.JO: "Njorondani",
			territory.JP: "Njabani",
			territory.KE: "Kenya",
