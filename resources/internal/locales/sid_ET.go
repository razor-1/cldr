...
func Get_sid_ET() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			language.SID: "Sidaamu Afo",
		},
		Territories: cldr.Territories{
			territory.ET: "Itiyoophiya",
		},
	}
}
