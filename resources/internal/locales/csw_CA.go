...
func Get_csw_CA() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "csw_CA",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "y MMMM d, EEEE", Long: "y MMMM d", Medium: "y MMM d", Short: "y-MM-dd"}, Time: cldr.CalendarDateFormat{Full: "h:mm:ss\u202fa zzzz", Long: "h:mm:ss\u202fa z", Medium: "h:mm:ss\u202fa", Short: "h:mm\u202fa"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "ᐅᒉᒥᑮᓯᑳᐏᐲᓯᒼ", Feb: "ᐸᐚᐦᒐᑭᓇᓰᐢ", Mar: "ᒥᑭᓯᐏᐲᓯᒼ", Apr: "ᓂᐢᑭᐲᓯᒼ", May: "ᐊᓃᑭᐲᓯᒼ", Jun: "ᐚᐏᐲᓯᒼ", Jul: "ᐹᐢᑲᐦᐋᐏᐲᓯᒼ", Aug: "ᐅᐸᐦᐅᐏᐲᓯᒼ", Sep: "ᓄᒌᑐᐏᐲᓯᒼ", Oct: "ᐱᓈᐢᑯᐏᐲᓯᒼ", Nov: "ᐋᕽᐘᑎᓄᐏᐲᓯᒼ", Dec: "ᒪᑯᓭᑮᓭᑳᐏᐲᓯᒼ"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "1", Feb: "2", Mar: "3", Apr: "4", May: "5", Jun: "6", Jul: "7", Aug: "8", Sep: "9", Oct: "10", Nov: "11", Dec: "12"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "ᐅᒉᒥᑮᓯᑳᐏᐲᓯᒼ", Feb: "ᐸᐚᐦᒐᑭᓇᓰᐢ", Mar: "ᒥᑭᓯᐏᐲᓯᒼ", Apr: "ᓂᐢᑭᐲᓯᒼ", May: "ᐊᓃᑭᐲᓯᒼ", Jun: "ᐚᐏᐲᓯᒼ", Jul: "ᐹᐢᑲᐦᐋᐏᐲᓯᒼ", Aug: "ᐅᐸᐦᐅᐏᐲᓯᒼ", Sep: "ᓄᒌᑐᐏᐲᓯᒼ", Oct: "ᐱᓈᐢᑯᐏᐲᓯᒼ", Nov: "ᐋᕽᐘᑎᓄᐏᐲᓯᒼ", Dec: "ᒪᑯᓭᑮᓭᑳᐏᐲᓯᒼ"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Mon: "ᐴᓂ\u00a0ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Tue: "ᓃᓱᑮᓯᑳᐤ", Wed: "ᐋᐱᐦᑕᐘᐣ", Thu: "ᐴᓂᐋᐱᐦᑕᐘᐣ", Fri: "ᑫᑳᐨ ᒫᑎᓇᐍᑮᓯᑳᐤ", Sat: "ᒫᑎᓇᐍᑮᓯᑳᐤ"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "ᐊ", Mon: "ᐴ", Tue: "ᓃ", Wed: "ᐋ", Thu: "ᐴ", Fri: "ᑫ", Sat: "ᒫ"}, Short: cldr.CalendarDayFormatNameValue{Sun: "ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Mon: "ᐴᓂ\u00a0ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Tue: "ᓃᓱᑮᓯᑳᐤ", Wed: "ᐋᐱᐦᑕᐘᐣ", Thu: "ᐴᓂᐋᐱᐦᑕᐘᐣ", Fri: "ᑫᑳᐨ ᒫᑎᓇᐍᑮᓯᑳᐤ", Sat: "ᒫᑎᓇᐍᑮᓯᑳᐤ"}, Wide: cldr.CalendarDayFormatNameValue{Sun: "ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Mon: "ᐴᓂ\u00a0ᐊᔭᒥᐦᐁᑮᓯᑳᐤ", Tue: "ᓃᓱᑮᓯᑳᐤ", Wed: "ᐋᐱᐦᑕᐘᐣ", Thu: "ᐴᓂᐋᐱᐦᑕᐘᐣ", Fri: "ᑫᑳᐨ ᒫᑎᓇᐍᑮᓯᑳᐤ", Sat: "ᒫᑎᓇᐍᑮᓯᑳᐤ"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "ᐊᒼ", PM: "ᐲᒼ"}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "ᐊᒼ", PM: "ᐲᒼ"}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "ᐊᒼ", PM: "ᐲᒼ"}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.CAD: cldr.Currency{DisplayName: "ᑲᓀᑎᔭᐣ ᐯᔭᐠᐚᐱᐢᐠ", Symbol: "CA$"},
		...
		Languages: cldr.Languages{
			language.CHR:   "ᒉᕑᐅᑫᕀ",
			language.CSW:   "ᓀᐦᐃᓇᐍᐏᐣ",
			language.EN:    "ᐊᑲᓈᓰᒧᐏᐣ",
			language.EN_AU: "ᐊᑲᓈᓰᒧᐏᐣ (AU)",
			language.EN_CA: "ᐊᑲᓈᓰᒧᐏᐣ (ᑳᓇᑕ)",
			language.EN_GB: "ᐊᑲᓈᓰᒧᐏᐣ (GB)",
			language.EN_US: "ᐊᑲᓈᓰᒧᐏᐣ (US)",
			language.FR:    "ᐹᕽᐘᔦᓰᒧᐏᐣ",
			language.FR_CA: "ᐹᕽᐘᔦᓰᒧᐏᐣ (ᑳᓇᑕ)",
			language.FR_CH: "ᐹᕽᐘᔦᓰᒧᐏᐣ (CH)",
			language.HE:    "ᐦᐄᑊᕑᐅᐤ",
			language.MUL:   "ᒥᐦᒉᐟ ᐊᔭᒧᐏᓇ",
			language.UND:   "ᓇᒨᓇ ᐃᐦᑕᐟᐘᐣ ᐊᔭᒧᐏᐣ",
		},
		Territories: cldr.Territories{
			territory.V_001: "ᐊᐢᑭᕀ",
			territory.V_003: "ᒥᐦᑭᓇᕽ ᒥᓂᐢᑎᐠ",
			territory.V_005: "ᓵᐘᓄᕽ ᒥᐦᑭᓇᕽ ᒥᓂᐢᑎᐠ",
			territory.V_013: "ᐋᐱᐦᑕᐤ ᒥᐦᑭᓇᕽ ᒥᓂᐢᑎᐠ",
			territory.V_021: "ᑮᐍᑎᓄᕽ ᒥᐦᑭᓇᕽ ᒥᓂᐢᑎᐠ",
			territory.CA:    "ᑳᓇᑕ",
			territory.EU:    "ᐊᑳᒪᐢᑮᔭ",
			territory.EZ:    "ᐊᑳᒪᐢᑮᕽ",
			territory.UN:    "ᒫᒫᐏ ᐊᐢᑮᔭ",
			territory.US:    "ᑭᐦᒋ ᒨᑯᒫᓂᕽ",
		},
	}
}
