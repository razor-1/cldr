...
func Get_mdf_RU() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			language.DE:  "Саксонь кяль",
			language.EN:  "Англань кяль",
			language.ES:  "Испаниянь кяль",
			language.FR:  "Кранциянь кяль",
			language.IT:  "Италиянь кяль",
			language.JA:  "Япононь кяль",
			language.MDF: "мокшень кяль",
			language.PL:  "Поляконь кяль",
			language.PT:  "Португалонь кяль",
			language.RU:  "Рузонь кяль",
			language.TR:  "Туркань кяль",
		},
		Territories: cldr.Territories{
			territory.V_001: "масторланга",
			territory.V_002: "Африкась",
			territory.V_003: "Кельмеширень Америкась",
			territory.V_005: "Лямбеширень Америкась",
			territory.V_013: "Кучкань Америкась",
			territory.V_017: "Кучкань Африкась",
			territory.V_019: "Америкась",
			territory.V_142: "Азиясь",
			territory.V_150: "Европась",
