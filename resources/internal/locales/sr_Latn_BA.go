	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BYN: cldr.Currency{DisplayName: "Bjeloruska rublja", Symbol: ""},
		...
		Territories: cldr.Territories{
			...
			territory.BN:    "Bruneji",
			territory.BV:    "ostrvo Buve",
			territory.BY:    "Bjelorusija",
			territory.CC:    "Kokosova (Kiling) ostrva",
			...
			territory.HK:    "Hongkong (SAO Kine)",
			territory.HM:    "ostrvo Herd i ostrva Makdonald",
			territory.KM:    "Komori",
			...
			territory.UM:    "Spoljna ostrva SAD",
