...
func Get_tpi_PG() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "tpi_PG",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEE, dd MMMM y", Long: "dd MMMM y", Medium: "dd MMM y", Short: "dd/MM/yy"}, Time: cldr.CalendarDateFormat{Full: "hh:mm:ss\u202fa zzzz", Long: "hh:mm:ss\u202fa zzz", Medium: "hh:mm:ss\u202fa", Short: "hh:mm\u202fa"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "Jan", Feb: "Feb", Mar: "Mas", Apr: "Epr", May: "Me", Jun: "Jun", Jul: "Jul", Aug: "Oga", Sep: "Sep", Oct: "Okt", Nov: "Nov", Dec: "Des"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "1", Feb: "2", Mar: "3", Apr: "4", May: "5", Jun: "6", Jul: "7", Aug: "8", Sep: "9", Oct: "10", Nov: "11", Dec: "12"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Janueri", Feb: "Februeri", Mar: "Mas", Apr: "Epril", May: "Me", Jun: "Jun", Jul: "Julai", Aug: "Ogas", Sep: "Septemba", Oct: "Oktoba", Nov: "Novemba", Dec: "Desemba"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "San", Mon: "Man", Tue: "Tun", Wed: "Tri", Thu: "Fon", Fri: "Fra", Sat: "Sar"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "S", Mon: "M", Tue: "T", Wed: "W", Thu: "T", Fri: "F", Sat: "S"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Sande", Mon: "Mande", Tue: "Tunde", Wed: "Trinde", Thu: "Fonde", Fri: "Fraide", Sat: "Sarere"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
		...
		Languages: cldr.Languages{
			language.DE:      "Jeman",
			language.DE_AT:   "Austria Jeman",
			language.DE_CH:   "Swis Jeman",
			language.EN:      "Inglis",
			language.EN_AU:   "Australian Inglis",
			language.EN_CA:   "Kenedien Inglis",
			language.EN_GB:   "Britis Inglis",
			language.EN_US:   "Amerikan Inglis",
			language.ES:      "Spenis",
			language.ES_419:  "Saut Amerikan Spenis",
			language.ES_ES:   "Spenis (Spein)",
			language.ES_MX:   "Meksikan Spenis",
			language.FR:      "Frens",
			language.FR_CA:   "Kenedien Frens",
			language.FR_CH:   "Swis Frens",
			language.IT:      "Italien",
			language.JA:      "Japanis",
			language.PT:      "Potigis",
			language.PT_BR:   "Brasilien Potigis",
			language.PT_PT:   "Yurop Potigis",
			language.RU:      "Rasien",
			language.TPI:     "Tok Pisin",
			language.UND:     "Tok ples i no stap",
			language.ZH:      "Sainis",
			language.ZH_HANS: "Isipela Sainis",
			language.ZH_HANT: "Tredisinol Sainis",
		},
		Territories: cldr.Territories{
			...
			territory.DE: "Jemani",
			territory.FR: "Frans",
			territory.GB: "Yunaited Kingdom",
			territory.IN: "India",
			territory.IT: "Itali",
			territory.PG: "Papua Niugini",
			territory.ZZ: "Rijen i no stap",
		},
	}
}
