...
func Get_ts_ZA() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "ts_ZA",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "y MMMM d, EEEE", Long: "y MMMM d", Medium: "y MMM d", Short: "y-MM-dd"}, Time: cldr.CalendarDateFormat{Full: "HH:mm:ss zzzz", Long: "HH:mm:ss z", Medium: "HH:mm:ss", Short: "HH:mm"}, DateTime: cldr.CalendarDateFormat{Full: "{1} {0}", Long: "{1} {0}", Medium: "{1} {0}", Short: "{1} {0}"}, GMT: "GMT{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "Sun", Feb: "Yan", Mar: "Kul", Apr: "Dzi", May: "Mud", Jun: "Kho", Jul: "Maw", Aug: "Mha", Sep: "Ndz", Oct: "Nhl", Nov: "Huk", Dec: "N’w"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "1", Feb: "2", Mar: "3", Apr: "4", May: "5", Jun: "6", Jul: "7", Aug: "8", Sep: "9", Oct: "10", Nov: "11", Dec: "12"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "Sunguti", Feb: "Nyenyenyani", Mar: "Nyenyankulu", Apr: "Dzivamisoko", May: "Mudyaxihi", Jun: "Khotavuxika", Jul: "Mawuwani", Aug: "Mhawuri", Sep: "Ndzhati", Oct: "Nhlangula", Nov: "Hukuri", Dec: "N’wendzamhala"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "Son", Mon: "Mus", Tue: "Bir", Wed: "Har", Thu: "Ne", Fri: "Tlh", Sat: "Mug"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "S", Mon: "M", Tue: "T", Wed: "W", Thu: "T", Fri: "F", Sat: "S"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "Sonta", Mon: "Musumbhunuku", Tue: "Ravumbirhi", Wed: "Ravunharhu", Thu: "Ravumune", Fri: "Ravuntlhanu", Sat: "Mugqivela"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}}}},
		Number: cldr.Number{
		...
		Languages: cldr.Languages{
			language.CS: "Xi Czech",
			language.DA: "Xi Danish",
			language.DE: "Xi Jarimani",
			language.EL: "Xi Giriki",
			language.EN: "Xi Nghezi",
			language.ES: "Xi spain",
			language.ET: "hi xi Estonia",
			language.FI: "Xi Finnish",
			language.FR: "Xi Furwa",
			language.HE: "XiHeberu",
			language.HU: "hi xi Hungary",
			language.IS: "hi xi Iceland",
			language.IT: "Xi Ithali",
			language.JA: "Xi Japani",
			language.KO: "Xikorea",
			language.LT: "hi xi Lithuania",
			language.LV: "hi xi Latvia",
			language.NL: "Xi bunu",
			language.NO: "Xi Norway",
			language.PL: "Xi Polixi",
			language.PT: "Putukezi",
			language.RO: "hi xi Romania",
			language.RU: "Xi Rhaxiya",
			language.SV: "Xi Swiden",
