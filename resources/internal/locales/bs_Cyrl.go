	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BYN: cldr.Currency{DisplayName: "Белоруска рубља", Symbol: ""},
				...
				currency.GHS: cldr.Currency{DisplayName: "Гански цеди", Symbol: "GH₵"},
				...
				currency.XOF: cldr.Currency{DisplayName: "CFA франак BCEAO", Symbol: "F\u202fCFA"},
		...
		Languages: cldr.Languages{
			...
			language.ARS:     "најди арапски",
			language.ARW:     "аравак",
			language.AS:      "асемијски",
			language.ASA:     "асу",
			language.AST:     "астуријски",
			language.ATJ:     "атикамекв",
			language.AV:      "аварски",
			language.AWA:     "авадхи",
			language.AY:      "ајмара",
			language.AZ:      "азерски",
			...
			language.CRJ:     "јужноисточни кре",
			language.CRK:     "равничарски кре",
			language.CRL:     "сјеверно источни кре",
			language.CRM:     "мосе кре",
			language.CRR:     "алгонкуански за Каролину",
			language.CS:      "чешки",
			language.CSB:     "кашубијански",
			language.CSW:     "свампи кре",
			...
			language.IK:      "унупиак",
			language.IKT:     "западно канадски инуктитут",
			language.ILO:     "илоко",
			...
			language.OJ:      "ојибва",
			language.OJB:     "сјеверозападни ојибва",
			language.OJC:     "Централни обијва",
			language.OJS:     "оји-кре",
			language.OJW:     "западни ојибва",
			...
			language.PCM:     "нигеријски пидгин",
			...
			language.PQM:     "малисет-шасамкуоди",
			language.PRG:     "пруски",
			...
			language.ZH_HANS: "кинески мандариснки поједностављен",
			language.ZH_HANT: "кинески мандарински (традиционални)",
			language.ZU:      "зулу",
			language.ZUN:     "зуни",
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "Демократска Република Конго",
			...
			territory.US:    "Сједињене Америчке Државе",
