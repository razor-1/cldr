	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Ihela ya Siela Liyoni", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Ihela ya Siela Liyoni (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Ihela ya CFA BCEAO", Symbol: "F\u202fCFA"},
