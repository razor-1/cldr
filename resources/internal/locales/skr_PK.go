...
func Get_skr_PK() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			language.EN:  "سرائیکی ► skr",
			language.SKR: "سرائیکی",
		},
