	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.CAD: cldr.Currency{DisplayName: "دۆلاری کەنەدی", Symbol: "CA$"},
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "کۆنگۆ کینشاسا",
			territory.CF:    "کۆماری ئەفریقای ناوەڕاست",
			territory.CG:    "کۆنگۆ برازاڤیل",
			territory.CH:    "سویسڕا",
			...
			territory.PS:    "ناوچە فەلەستینیەکان",
