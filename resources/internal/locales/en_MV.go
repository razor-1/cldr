	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.MVR: cldr.Currency{DisplayName: "Maldivian Rufiyaa", Symbol: "Rf"},
