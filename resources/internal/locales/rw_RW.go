...
func Get_rw_RW() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			language.AF:    "Ikinyafurikaneri",
			language.AM:    "Inyamuhariki",
			language.AR:    "Icyarabu",
			language.AS:    "Icyasamizi",
			language.AZ:    "Inyazeribayijani",
			language.BE:    "Ikibelarusiya",
			language.BG:    "Urunyabuligariya",
			language.BN:    "Ikibengali",
			language.BR:    "Inyebiritoni",
			language.BS:    "Inyebosiniya",
			language.CA:    "Igikatalani",
			language.CS:    "Igiceke",
			language.CY:    "Ikigaluwa",
			language.DA:    "Ikidaninwa",
			language.DE:    "Ikidage",
			language.EL:    "Ikigereki",
			language.EN:    "Icyongereza",
			language.EO:    "Icyesiperanto",
			language.ES:    "Icyesipanyolo",
			language.ET:    "Icyesitoniya",
			language.EU:    "Ikibasiki",
			language.FA:    "Inyeperisi",
			language.FI:    "Igifinilande",
			language.FIL:   "Ikinyafilipine",
			language.FO:    "Inyefaroyizi",
			language.FR:    "Igifaransa",
			language.FY:    "Igifiriziyani",
			language.GA:    "Ikirilandi",
			language.GD:    "Ikigaluwa cy’Igisweduwa",
			language.GL:    "Ikigalisiya",
			language.GN:    "Inyaguwarani",
			language.GU:    "Inyegujarati",
			language.HE:    "Igiheburayo",
			language.HI:    "Igihindi",
			language.HR:    "Igikorowasiya",
			language.HU:    "Igihongiriya",
			language.HY:    "Ikinyarumeniya",
			language.IA:    "Ururimi Gahuzamiryango",
			language.ID:    "Ikinyendoziya",
			language.IE:    "Uruhuzandimi",
			language.IS:    "Igisilande",
			language.IT:    "Igitaliyani",
			language.JA:    "Ikiyapani",
			language.JV:    "Inyejava",
			language.KA:    "Inyejeworujiya",
			language.KM:    "Igikambodiya",
			language.KN:    "Igikanada",
			language.KO:    "Igikoreya",
			language.KU:    "Inyekuridishi",
			language.KY:    "Inkerigizi",
			language.LA:    "Ikilatini",
			language.LN:    "Ilingala",
			language.LO:    "Ikilawotiyani",
			language.LT:    "Ikilituwaniya",
			language.LV:    "Ikinyaletoviyani",
			language.MK:    "Ikimasedoniya",
			language.ML:    "Ikimalayalami",
			language.MN:    "Ikimongoli",
			language.MR:    "Ikimarati",
			language.MS:    "Ikimalayi",
			language.MT:    "Ikimaliteze",
			language.NE:    "Ikinepali",
			language.NL:    "Ikinerilande",
			language.NN:    "Inyenoruveji (Nyonorusiki)",
			language.NO:    "Ikinoruveji",
			language.OC:    "Inyogusitani",
			language.OR:    "Inyoriya",
			language.PA:    "Igipunjabi",
			language.PL:    "Igipolone",
			language.PS:    "Impashito",
			language.PT:    "Igiporutugali",
			language.PT_BR: "Inyeporutigali (Brezili)",
			language.PT_PT: "Inyeporutigali (Igiporutigali)",
			language.RO:    "Ikinyarumaniya",
			language.RU:    "Ikirusiya",
			language.RW:    "Ikinyarwanda",
			language.SA:    "Igisansikiri",
			language.SD:    "Igisindi",
			language.SH:    "Inyeseribiya na Korowasiya",
			language.SI:    "Inyesimpaleze",
			language.SK:    "Igisilovaki",
			language.SL:    "Ikinyasiloveniya",
			language.SO:    "Igisomali",
			language.SQ:    "Icyalubaniya",
			language.SR:    "Igiseribe",
			language.ST:    "Inyesesoto",
			language.SU:    "Inyesudani",
			language.SV:    "Igisuweduwa",
			language.SW:    "Igiswahili",
			language.TA:    "Igitamili",
			language.TE:    "Igitelugu",
			language.TH:    "Igitayi",
			language.TI:    "Inyatigirinya",
			language.TK:    "Inyeturukimeni",
			language.TLH:   "Inyekilingoni",
			language.TR:    "Igiturukiya",
			language.TW:    "Inyetuwi",
			language.UG:    "Ikiwiguri",
			language.UK:    "Ikinyayukereni",
			language.UR:    "Inyeyurudu",
			language.UZ:    "Inyeyuzubeki",
			language.VI:    "Ikinyaviyetinamu",
			language.XH:    "Inyehawusa",
			language.YI:    "Inyeyidishi",
			language.ZU:    "Inyezulu",
		},
		Territories: cldr.Territories{
			territory.MK: "Masedoniya y’Amajyaruguru",
