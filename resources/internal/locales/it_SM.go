	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.CAD: cldr.Currency{DisplayName: "dollaro canadese", Symbol: "CA$"},
				...
				currency.CNH: cldr.Currency{DisplayName: "renmimbi cinese offshore", Symbol: ""},
				currency.CNY: cldr.Currency{DisplayName: "yuan cinese", Symbol: "CN¥"},
				...
				currency.MKD: cldr.Currency{DisplayName: "dinaro macedone", Symbol: ""},
				currency.MKN: cldr.Currency{DisplayName: "dinaro macedone (1992–1993)", Symbol: ""},
				...
				currency.MRU: cldr.Currency{DisplayName: "ouguiya della Mauritania", Symbol: ""},
				...
				currency.PLN: cldr.Currency{DisplayName: "zloty polacco", Symbol: "zł"},
				...
				currency.RUR: cldr.Currency{DisplayName: "rublo della CSI", Symbol: ""},
				...
				currency.SLE: cldr.Currency{DisplayName: "leone della Sierra Leone", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "leone della Sierra Leone (1964–2022)", Symbol: ""},
				...
				currency.STN: cldr.Currency{DisplayName: "dobra di Sao Tomé e Príncipe", Symbol: "Db"},
				...
				currency.XCD: cldr.Currency{DisplayName: "dollaro dei Caraibi orientali", Symbol: "EC$"},
		...
		Languages: cldr.Languages{
			...
			language.CRK:     "cree delle pianure",
			language.CRL:     "cree nord-orientale",
			language.CRM:     "cree moose",
			language.CRR:     "algonchino della Carolina",
			language.CRS:     "creolo delle Seychelles",
			language.CS:      "ceco",
			language.CSB:     "kashubian",
			language.CSW:     "cree delle paludi",
			language.CU:      "slavo ecclesiastico",
			...
			language.IK:      "inupiak",
			language.IKT:     "inuktitut canadese occidentale",
			...
			language.OJ:      "ojibwa",
			language.OJB:     "ojibwe nord-occidentale",
			language.OJC:     "ojibwe centrale",
			language.OJS:     "oji-cree",
			language.OJW:     "ojibwe occidentale",
			...
			language.TT:      "tataro",
			language.TTM:     "tutchone settentrionale",
		...
		Territories: cldr.Territories{
			...
			territory.PS:    "Territori Palestinesi",
			...
			territory.UG:    "Uganda",
			territory.UM:    "Isole Minori Esterne degli Stati Uniti",
