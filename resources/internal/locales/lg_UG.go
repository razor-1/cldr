	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Lewone", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Lewone (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Faranga ey’omu Afirika ey’ebugwanjuba", Symbol: "F\u202fCFA"},
