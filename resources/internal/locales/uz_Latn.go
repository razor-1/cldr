	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				currency.AED: cldr.Currency{DisplayName: "Birlashgan Arab Amirliklari dirhami", Symbol: ""},
				currency.AFN: cldr.Currency{DisplayName: "Afg‘oniston afg‘oniysi", Symbol: "؋"},
				currency.ALL: cldr.Currency{DisplayName: "Albaniya leki", Symbol: ""},
				currency.AMD: cldr.Currency{DisplayName: "Armaniston drami", Symbol: "֏"},
				currency.ANG: cldr.Currency{DisplayName: "Niderlandiya antil guldeni", Symbol: ""},
				currency.AOA: cldr.Currency{DisplayName: "Angola kvanzasi", Symbol: "Kz"},
				currency.ARS: cldr.Currency{DisplayName: "Argentina pesosi", Symbol: "$"},
				...
				currency.AZN: cldr.Currency{DisplayName: "Ozarbayjon manati", Symbol: "₼"},
				currency.BAM: cldr.Currency{DisplayName: "Bosniya va Gertsegovina ayirboshlash markasi", Symbol: "KM"},
				currency.BBD: cldr.Currency{DisplayName: "Barbados dollari", Symbol: "$"},
				currency.BDT: cldr.Currency{DisplayName: "Bangladesh takasi", Symbol: "৳"},
				currency.BGN: cldr.Currency{DisplayName: "Bolgariya levi", Symbol: ""},
				currency.BHD: cldr.Currency{DisplayName: "Bahrayn dinori", Symbol: ""},
				currency.BIF: cldr.Currency{DisplayName: "Burundi franki", Symbol: ""},
				currency.BMD: cldr.Currency{DisplayName: "Bermuda dollari", Symbol: "$"},
				currency.BND: cldr.Currency{DisplayName: "Bruney dollari", Symbol: "$"},
				currency.BOB: cldr.Currency{DisplayName: "Boliviya bolivianosi", Symbol: "Bs"},
				currency.BRL: cldr.Currency{DisplayName: "Braziliya reali", Symbol: "R$"},
				currency.BSD: cldr.Currency{DisplayName: "Bagama dollari", Symbol: "$"},
				currency.BTN: cldr.Currency{DisplayName: "Butan ngultrumi", Symbol: ""},
				currency.BWP: cldr.Currency{DisplayName: "Botsvana pulasi", Symbol: "P"},
				currency.BYN: cldr.Currency{DisplayName: "Belarus rubli", Symbol: "р."},
				currency.BYR: cldr.Currency{DisplayName: "Belarus rubli (2000–2016)", Symbol: ""},
				currency.BZD: cldr.Currency{DisplayName: "Beliz dollari", Symbol: "$"},
				currency.CAD: cldr.Currency{DisplayName: "Kanada dollari", Symbol: "CA$"},
				currency.CDF: cldr.Currency{DisplayName: "Kongo franki", Symbol: ""},
				currency.CHF: cldr.Currency{DisplayName: "Shveytsariya franki", Symbol: ""},
				currency.CLP: cldr.Currency{DisplayName: "Chili pesosi", Symbol: "$"},
				currency.CNH: cldr.Currency{DisplayName: "Xitoy yuani (ofshor)", Symbol: ""},
				currency.CNY: cldr.Currency{DisplayName: "Xitoy yuani", Symbol: "CN¥"},
				currency.COP: cldr.Currency{DisplayName: "Kolumbiya pesosi", Symbol: "$"},
				currency.CRC: cldr.Currency{DisplayName: "Kosta-Rika koloni", Symbol: "₡"},
				currency.CUC: cldr.Currency{DisplayName: "Kuba ayirboshlash pesosi", Symbol: "$"},
				currency.CUP: cldr.Currency{DisplayName: "Kuba pesosi", Symbol: "$"},
				currency.CVE: cldr.Currency{DisplayName: "Kabo-Verde eskudosi", Symbol: ""},
				currency.CZK: cldr.Currency{DisplayName: "Chexiya kronasi", Symbol: "Kč"},
				currency.DJF: cldr.Currency{DisplayName: "Jibuti franki", Symbol: ""},
				currency.DKK: cldr.Currency{DisplayName: "Daniya kronasi", Symbol: "kr"},
				currency.DOP: cldr.Currency{DisplayName: "Dominikana pesosi", Symbol: "$"},
				currency.DZD: cldr.Currency{DisplayName: "Jazoir dinori", Symbol: ""},
				currency.EGP: cldr.Currency{DisplayName: "Misr funti", Symbol: "E£"},
				currency.ERN: cldr.Currency{DisplayName: "Eritreya nakfasi", Symbol: ""},
				currency.ESP: cldr.Currency{DisplayName: "", Symbol: "₧"},
				currency.ETB: cldr.Currency{DisplayName: "Efiopiya biri", Symbol: ""},
				currency.EUR: cldr.Currency{DisplayName: "Yevro", Symbol: "€"},
				currency.FJD: cldr.Currency{DisplayName: "Fiji dollari", Symbol: "$"},
				currency.FKP: cldr.Currency{DisplayName: "Folklend orollari funti", Symbol: "£"},
				currency.GBP: cldr.Currency{DisplayName: "Angliya funt sterlingi", Symbol: "£"},
				currency.GEL: cldr.Currency{DisplayName: "Gruziya larisi", Symbol: "₾"},
				currency.GHS: cldr.Currency{DisplayName: "Gana sedisi", Symbol: "GH₵"},
				currency.GIP: cldr.Currency{DisplayName: "Gibraltar funti", Symbol: "£"},
				currency.GMD: cldr.Currency{DisplayName: "Gambiya dalasisi", Symbol: ""},
				currency.GNF: cldr.Currency{DisplayName: "Gvineya franki", Symbol: "FG"},
				currency.GTQ: cldr.Currency{DisplayName: "Gvatemala ketsali", Symbol: "Q"},
				currency.GYD: cldr.Currency{DisplayName: "Gayana dollari", Symbol: "$"},
				currency.HKD: cldr.Currency{DisplayName: "Gonkong dollari", Symbol: "HK$"},
				currency.HNL: cldr.Currency{DisplayName: "Gonduras lempirasi", Symbol: "L"},
				currency.HRK: cldr.Currency{DisplayName: "Xorvatiya kunasi", Symbol: "kn"},
				currency.HTG: cldr.Currency{DisplayName: "Gaiti gurdi", Symbol: ""},
				currency.HUF: cldr.Currency{DisplayName: "Vengriya forinti", Symbol: "Ft"},
				currency.IDR: cldr.Currency{DisplayName: "Indoneziya rupiyasi", Symbol: "Rp"},
				...
				currency.IQD: cldr.Currency{DisplayName: "Iroq dinori", Symbol: ""},
				currency.IRR: cldr.Currency{DisplayName: "Eron riyoli", Symbol: ""},
				currency.ISK: cldr.Currency{DisplayName: "Islandiya kronasi", Symbol: "kr"},
				currency.JMD: cldr.Currency{DisplayName: "Yamayka dollari", Symbol: "$"},
				currency.JOD: cldr.Currency{DisplayName: "Iordaniya dinori", Symbol: ""},
				currency.JPY: cldr.Currency{DisplayName: "Yaponiya iyenasi", Symbol: "JP¥"},
				currency.KES: cldr.Currency{DisplayName: "Keniya shillingi", Symbol: ""},
				currency.KGS: cldr.Currency{DisplayName: "Qirg‘iziston somi", Symbol: "⃀"},
				currency.KHR: cldr.Currency{DisplayName: "Kambodja rieli", Symbol: "៛"},
				currency.KMF: cldr.Currency{DisplayName: "Komor orollari franki", Symbol: "CF"},
				currency.KPW: cldr.Currency{DisplayName: "Shimoliy Koreya voni", Symbol: "₩"},
				currency.KRW: cldr.Currency{DisplayName: "Janubiy Koreya voni", Symbol: "₩"},
				currency.KWD: cldr.Currency{DisplayName: "Kuvayt dinori", Symbol: ""},
				currency.KYD: cldr.Currency{DisplayName: "Kayman orollari dollari", Symbol: "$"},
				currency.KZT: cldr.Currency{DisplayName: "Qozog‘iston tengesi", Symbol: "₸"},
				currency.LAK: cldr.Currency{DisplayName: "Laos kipi", Symbol: "₭"},
				currency.LBP: cldr.Currency{DisplayName: "Livan funti", Symbol: "L£"},
				currency.LKR: cldr.Currency{DisplayName: "Shri-Lanka rupiyasi", Symbol: "Rs"},
				currency.LRD: cldr.Currency{DisplayName: "Liberiya dollari", Symbol: "$"},
				currency.LSL: cldr.Currency{DisplayName: "Lesoto lotisi", Symbol: ""},
				currency.LTL: cldr.Currency{DisplayName: "Litva liti", Symbol: "Lt"},
				currency.LVL: cldr.Currency{DisplayName: "Latviya lati", Symbol: "Ls"},
				currency.LYD: cldr.Currency{DisplayName: "Liviya dinori", Symbol: ""},
				currency.MAD: cldr.Currency{DisplayName: "Marokash dirhami", Symbol: ""},
				currency.MDL: cldr.Currency{DisplayName: "Moldova leyi", Symbol: ""},
				currency.MGA: cldr.Currency{DisplayName: "Malagasi ariarisi", Symbol: "Ar"},
				currency.MKD: cldr.Currency{DisplayName: "Makedoniya dinori", Symbol: ""},
				currency.MMK: cldr.Currency{DisplayName: "Myanma kyati", Symbol: "K"},
				currency.MNT: cldr.Currency{DisplayName: "Mongoliya tugriki", Symbol: "₮"},
				currency.MOP: cldr.Currency{DisplayName: "Makao patakasi", Symbol: ""},
				currency.MRO: cldr.Currency{DisplayName: "Mavritaniya uqiyasi (1973–2017)", Symbol: ""},
				currency.MRU: cldr.Currency{DisplayName: "Mavritaniya uqiyasi", Symbol: ""},
				currency.MUR: cldr.Currency{DisplayName: "Mavritaniya rupiyasi", Symbol: "Rs"},
				currency.MVR: cldr.Currency{DisplayName: "Maldiv rupiyasi", Symbol: ""},
				currency.MWK: cldr.Currency{DisplayName: "Malavi kvachasi", Symbol: ""},
				currency.MXN: cldr.Currency{DisplayName: "Meksika pesosi", Symbol: "MX$"},
				currency.MYR: cldr.Currency{DisplayName: "Malayziya ringgiti", Symbol: "RM"},
				currency.MZN: cldr.Currency{DisplayName: "Mozambik metikali", Symbol: ""},
				currency.NAD: cldr.Currency{DisplayName: "Namibiya dollari", Symbol: "$"},
				currency.NGN: cldr.Currency{DisplayName: "Nigeriya nayrasi", Symbol: "₦"},
				currency.NIO: cldr.Currency{DisplayName: "Nikaragua kordobasi", Symbol: "C$"},
				currency.NOK: cldr.Currency{DisplayName: "Norvegiya kronasi", Symbol: "kr"},
				currency.NPR: cldr.Currency{DisplayName: "Nepal rupiyasi", Symbol: "Rs"},
				currency.NZD: cldr.Currency{DisplayName: "Yangi Zelandiya dollari", Symbol: "NZ$"},
				currency.OMR: cldr.Currency{DisplayName: "Ummon riyoli", Symbol: ""},
				currency.PAB: cldr.Currency{DisplayName: "Panama balboasi", Symbol: ""},
				currency.PEN: cldr.Currency{DisplayName: "Peru soli", Symbol: ""},
				currency.PGK: cldr.Currency{DisplayName: "Papua – Yangi Gvineya kinasi", Symbol: ""},
				currency.PHP: cldr.Currency{DisplayName: "Filippin pesosi", Symbol: "PHP"},
				currency.PKR: cldr.Currency{DisplayName: "Pokiston rupiyasi", Symbol: "Rs"},
				currency.PLN: cldr.Currency{DisplayName: "Polsha zlotiyi", Symbol: "zł"},
				currency.PYG: cldr.Currency{DisplayName: "Paragvay guaranisi", Symbol: "₲"},
				currency.QAR: cldr.Currency{DisplayName: "Qatar riyoli", Symbol: ""},
				currency.RON: cldr.Currency{DisplayName: "Ruminiya leyi", Symbol: "lei"},
				currency.RSD: cldr.Currency{DisplayName: "Serbiya dinori", Symbol: ""},
				currency.RUB: cldr.Currency{DisplayName: "Rossiya rubli", Symbol: "₽"},
				currency.RWF: cldr.Currency{DisplayName: "Ruanda franki", Symbol: "RF"},
				currency.SAR: cldr.Currency{DisplayName: "Saudiya Arabistoni riyoli", Symbol: ""},
				currency.SBD: cldr.Currency{DisplayName: "Solomon orollari dollari", Symbol: "$"},
				currency.SCR: cldr.Currency{DisplayName: "Seyshel rupiyasi", Symbol: ""},
				currency.SDG: cldr.Currency{DisplayName: "Sudan funti", Symbol: ""},
				currency.SEK: cldr.Currency{DisplayName: "Shvetsiya kronasi", Symbol: "kr"},
				currency.SGD: cldr.Currency{DisplayName: "Singapur dollari", Symbol: "$"},
				currency.SHP: cldr.Currency{DisplayName: "Muqaddas Yelena oroli funti", Symbol: "£"},
				currency.SLE: cldr.Currency{DisplayName: "Syerra-Leone leonesi", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Syerra-Leone leonesi (1964—2022)", Symbol: ""},
				currency.SOS: cldr.Currency{DisplayName: "Somali shillingi", Symbol: ""},
				currency.SRD: cldr.Currency{DisplayName: "Surinam dollari", Symbol: "$"},
				currency.SSP: cldr.Currency{DisplayName: "Janubiy Sudan funti", Symbol: "£"},
				currency.STD: cldr.Currency{DisplayName: "San-Tome va Prinsipi dobrasi (1977–2017)", Symbol: ""},
				currency.STN: cldr.Currency{DisplayName: "San-Tome va Prinsipi dobrasi", Symbol: "Db"},
				currency.SYP: cldr.Currency{DisplayName: "Suriya funti", Symbol: "£"},
				currency.SZL: cldr.Currency{DisplayName: "Svazilend lilangenisi", Symbol: ""},
				currency.THB: cldr.Currency{DisplayName: "Tailand bati", Symbol: "฿"},
				currency.TJS: cldr.Currency{DisplayName: "Tojikiston somoniysi", Symbol: ""},
				currency.TMT: cldr.Currency{DisplayName: "Turkmaniston manati", Symbol: ""},
				currency.TND: cldr.Currency{DisplayName: "Tunis dinori", Symbol: ""},
				currency.TOP: cldr.Currency{DisplayName: "Tonga paangasi", Symbol: "T$"},
				currency.TRY: cldr.Currency{DisplayName: "Turk lirasi", Symbol: "₺"},
				currency.TTD: cldr.Currency{DisplayName: "Trinidad va Tobago dollari", Symbol: "$"},
				currency.TWD: cldr.Currency{DisplayName: "Yangi Tayvan dollari", Symbol: "NT$"},
				currency.TZS: cldr.Currency{DisplayName: "Tanzaniya shillingi", Symbol: ""},
				currency.UAH: cldr.Currency{DisplayName: "Ukraina grivnasi", Symbol: "₴"},
				currency.UGX: cldr.Currency{DisplayName: "Uganda shillingi", Symbol: ""},
				currency.USD: cldr.Currency{DisplayName: "AQSH dollari", Symbol: "US$"},
				currency.UYU: cldr.Currency{DisplayName: "Urugvay pesosi", Symbol: "$"},
				currency.UZS: cldr.Currency{DisplayName: "O‘zbekiston so‘mi", Symbol: "soʻm"},
				currency.VEF: cldr.Currency{DisplayName: "Venesuela bolivari (2008–2018)", Symbol: "Bs"},
				currency.VES: cldr.Currency{DisplayName: "Venesuela bolivari", Symbol: ""},
				currency.VND: cldr.Currency{DisplayName: "Vyetnam dongi", Symbol: "₫"},
				currency.VUV: cldr.Currency{DisplayName: "Vanuatu vatusi", Symbol: ""},
				currency.WST: cldr.Currency{DisplayName: "Samoa talasi", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "G‘arbiy Afrika CFA franki", Symbol: "F\u202fCFA"},
				...
				currency.YER: cldr.Currency{DisplayName: "Yaman riyoli", Symbol: ""},
				currency.ZAR: cldr.Currency{DisplayName: "Janubiy Afrika rendi", Symbol: "R"},
				currency.ZMW: cldr.Currency{DisplayName: "Zambiya kvachasi", Symbol: "ZK"},
			},
		},
		...
		Languages: cldr.Languages{
			...
			language.CHP:     "chipevyan",
			language.CHR:     "cheroki",
			language.CHY:     "cheyenn",
			language.CKB:     "sorani-kurd",
			language.CLC:     "chilkotin",
			language.CO:      "korsikan",
			language.CRG:     "michif",
			language.CRJ:     "janubi-sharqiy kri",
			language.CRK:     "tekislik kri",
			language.CRL:     "shomoli-sharqiy kri",
			language.CRM:     "mus kri",
			language.CRR:     "karolin algonkin",
			language.CRS:     "kreol (Seyshel)",
			language.CS:      "chex",
			language.CSW:     "botqoq kri",
			...
			language.FRC:     "kajun fransuz",
			language.FRR:     "shimoliy friz",
			language.FUR:     "friul",
			...
			language.IG:      "igbo",
			language.II:      "sichuan",
			language.IKT:     "sharqiy-kanada inuktitut",
			language.ILO:     "iloko",
			language.INH:     "ingush",
			language.IO:      "ido",
			language.IS:      "island",
			...
			language.LG:      "ganda",
			language.LI:      "limburg",
			language.LIJ:     "liguryan",
			language.LIL:     "lilluet",
			language.LKT:     "lakota",
			language.LMO:     "lombard",
			language.LN:      "lingala",
			language.LO:      "laos",
			language.LOU:     "luiziana kreol",
			language.LOZ:     "lozi",
			...
			language.OC:      "oksitan",
			language.OJB:     "shimoli-gʻarbiy ojibva",
			language.OJC:     "markaziy ijibve",
			language.OJS:     "oji-kri",
			language.OJW:     "gʻarbiy ojibva",
			...
			language.PQM:     "maliset-passamakvoddi",
			language.PRG:     "pruss",
			language.PS:      "pushtu",
			...
			language.SLH:     "janubiy lushutsid",
			language.SM:      "samoa",
			...
			language.SWB:     "qamar",
			language.SYR:     "suryoniy",
			language.SZL:     "silez",
			language.TA:      "tamil",
			language.TCE:     "janubiy tutchone",
			language.TE:      "telugu",
			language.TEM:     "timne",
			language.TEO:     "teso",
			language.TET:     "tetum",
			...
			language.TS:      "tsonga",
			language.TT:      "tatar",
			language.TTM:     "shimoliy tutchone",
		...
		Territories: cldr.Territories{
			...
			territory.CG:    "Kongo – Brazzavil",
			territory.CH:    "Shveytsariya",
			territory.CI:    "Kot-d’Ivuar",
			...
			territory.GY:    "Gayana",
			territory.HK:    "Gonkong (Xitoy MMH)",
			...
			territory.PS:    "Falastin hududlari",
			...
			territory.UN:    "Birlashgan Millatlar Tashkiloti",
			territory.US:    "Amerika Qo‘shma Shtatlari",
