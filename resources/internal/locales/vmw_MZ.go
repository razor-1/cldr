...
func Get_vmw_MZ() *cldr.Locale {
	return &cldr.Locale{
		...
		Languages: cldr.Languages{
			language.EN:  "ingles",
			language.VMW: "emakhuwa",
		},
		Territories: cldr.Territories{
			territory.MZ: "oMosambikhi",
		},
	}
}
