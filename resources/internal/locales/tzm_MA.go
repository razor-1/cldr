	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Lyun Usirralyuni", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Lyun Usirralyuni (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Frank CFA (BCEAO)", Symbol: "F\u202fCFA"},
