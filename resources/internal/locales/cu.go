	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BYN: cldr.Currency{DisplayName: "бѣлорꙋ́сскїй рꙋ́бль", Symbol: "р."},
				currency.BYR: cldr.Currency{DisplayName: "бѣлорꙋ́сскїй рꙋ́бль (2000–2016)", Symbol: ""},
				...
				currency.KGS: cldr.Currency{DisplayName: "кирги́зскїй сꙋ́мъ", Symbol: "⃀"},
