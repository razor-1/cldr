...
func Get_shi_Tfng_MA() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "shi_Tfng_MA",
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "ⵍⵉⵢⵓⵏ", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "ⵍⵉⵢⵓⵏ (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "ⴼⵔⴰⵏⴽ ⵚⵉⴼⴰ ⴱⵉⵙⴰⵡ", Symbol: "F\u202fCFA"},
