	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.PAB: cldr.Currency{DisplayName: "balboa panameño", Symbol: "B/."},
