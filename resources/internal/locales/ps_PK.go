	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.XXX: cldr.Currency{DisplayName: "نامعلومه مروجه پېسے", Symbol: "¤"},
		...
		Languages: cldr.Languages{
			...
			language.ANP:     "انگيکي",
			language.AR:      "عربي",
			language.AR_001:  "نوے معياري عربي",
			language.ARN:     "ماپوچه",
		...
		Territories: cldr.Territories{
			...
			territory.TC:    "د ترکیے او کیکاسو ټاپو",
			territory.TD:    "چاډ",
			territory.TF:    "د فرانسے جنوبي سیمے",
			territory.TG:    "ټوګو",
