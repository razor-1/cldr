	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Leonit", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Leonit (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Rabisiekab CFA BCEAO", Symbol: "F\u202fCFA"},
