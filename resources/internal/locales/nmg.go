	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Mɔn Leɔne", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Mɔn Leɔn (1964—2022)¨", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Fraŋ CFA BCEAO", Symbol: "F\u202fCFA"},
