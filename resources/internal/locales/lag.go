	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.SLE: cldr.Currency{DisplayName: "Leóoni", Symbol: ""},
				currency.SLL: cldr.Currency{DisplayName: "Leóoni (1964—2022)", Symbol: ""},
				...
				currency.XOF: cldr.Currency{DisplayName: "Faráanga ya CFA BCEAO", Symbol: "F\u202fCFA"},
