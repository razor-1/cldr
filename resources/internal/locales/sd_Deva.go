...
func Get_sd_Deva() *cldr.Locale {
	return &cldr.Locale{
		Locale:   "sd_Deva",
		Calendar: cldr.Calendar{Formats: cldr.CalendarFormats{Date: cldr.CalendarDateFormat{Full: "EEEE, MMMM d, y", Long: "MMMM d, y", Medium: "MMM d, y", Short: "M/d/yy"}, Time: cldr.CalendarDateFormat{Full: "h:mm:ss a zzzz", Long: "h:mm:ss a z", Medium: "h:mm:ss a", Short: "h:mm a"}, DateTime: cldr.CalendarDateFormat{Full: "{1}, {0}", Long: "{1}, {0}", Medium: "{1}, {0}", Short: "{1}, {0}"}, GMT: "जीएमटी{0}"}, FormatNames: cldr.CalendarFormatNames{Months: cldr.CalendarMonthFormatNames{Abbreviated: cldr.CalendarMonthFormatNameValue{Jan: "जन", Feb: "फर", Mar: "मार्च", Apr: "अप्रै", May: "मई", Jun: "जून", Jul: "जुला", Aug: "अग", Sep: "सप्टे", Oct: "ऑक्टो", Nov: "नवं", Dec: "डिसं"}, Narrow: cldr.CalendarMonthFormatNameValue{Jan: "ज", Feb: "फ़", Mar: "म", Apr: "अ", May: "मा", Jun: "जू", Jul: "जु", Aug: "अग", Sep: "स", Oct: "ऑ", Nov: "न", Dec: "डि"}, Short: cldr.CalendarMonthFormatNameValue{Jan: "", Feb: "", Mar: "", Apr: "", May: "", Jun: "", Jul: "", Aug: "", Sep: "", Oct: "", Nov: "", Dec: ""}, Wide: cldr.CalendarMonthFormatNameValue{Jan: "जनवरी", Feb: "फेबरवरी", Mar: "मार्चु", Apr: "अप्रेल", May: "मई", Jun: "जून", Jul: "जुलाई", Aug: "आगस्ट", Sep: "सप्टेंबर", Oct: "ऑक्टोबर", Nov: "नवंबर", Dec: "डिसंबर"}}, Days: cldr.CalendarDayFormatNames{Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "आ", Mon: "सू", Tue: "मं", Wed: "बुध", Thu: "विस", Fri: "जु", Sat: "छंछ"}, Narrow: cldr.CalendarDayFormatNameValue{Sun: "आ", Mon: "सू", Tue: "मं", Wed: "बु॒", Thu: "वि", Fri: "जु", Sat: "छं"}, Short: cldr.CalendarDayFormatNameValue{Sun: "", Mon: "", Tue: "", Wed: "", Thu: "", Fri: "", Sat: ""}, Wide: cldr.CalendarDayFormatNameValue{Sun: "आर्त", Mon: "सू", Tue: "मं", Wed: "बु॒ध", Thu: "विस", Fri: "जुम", Sat: "छंछ"}}, Periods: cldr.CalendarPeriodFormatNames{Abbreviated: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Narrow: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Short: cldr.CalendarPeriodFormatNameValue{AM: "", PM: ""}, Wide: cldr.CalendarPeriodFormatNameValue{AM: "सुबुह जा", PM: "शाम जा"}}}},
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.BRL: cldr.Currency{DisplayName: "ब्राज़ीली रियालु", Symbol: "R$"},
				...
				currency.CNY: cldr.Currency{DisplayName: "चीनी युआनु", Symbol: "CN¥"},
				...
				currency.USD: cldr.Currency{DisplayName: "यूएस जो डॉलर", Symbol: "$"},
				...
				currency.XXX: cldr.Currency{DisplayName: "अणजा॒तल सिको", Symbol: "¤"},
		...
		Languages: cldr.Languages{
			...
			language.ES:      "स्पेनिश",
			language.ES_419:  "लैटिन अमेरिकन स्पैनिश",
			language.ES_ES:   "यूरोपी स्पैनिश",
			language.ES_MX:   "मेक्सिकन स्पैनिश",
			language.FR:      "फ्रेंच",
			...
			language.PT_BR:   "ब्राज़ीलियन पुर्तगाली",
			language.PT_PT:   "यूरोपी पुर्तगाली",
			language.RU:      "रशियनु",
			language.SD:      "सिन्धी",
			language.UND:     "अणजा॒तल भाषा",
			language.ZH:      "चीनी, मैन्डरिन",
			language.ZH_HANS: "सादी थियल मैन्डरिन चीनी",
			language.ZH_HANT: "रवायती मैन्डरिन चीनी",
		},
