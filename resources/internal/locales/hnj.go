	...
	return &cldr.Locale{
		...
		Number: cldr.Number{
			...
			Currencies: cldr.Currencies{
				...
				currency.USD: cldr.Currency{DisplayName: "", Symbol: "𞅎"},
		...
		Languages: cldr.Languages{
			language.AR:  "𞄤𞄣",
			language.BN:  "𞄜𞄤",
			language.EN:  "𞄥𞄴𞄅𞄇𞄉𞄦𞄱𞄊",
			language.FR:  "𞄕𞄤𞄰𞄎𞄦𞄴",
			language.HMN: "𞄀𞄄𞄰𞄩",
			language.HNJ: "𞄀𞄄𞄰𞄩𞄍𞄜𞄰",
			language.ZH:  "𞄋𞄄",
		},
